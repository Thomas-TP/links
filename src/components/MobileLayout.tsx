    ...
    <div className="relative z-10 min-h-screen flex flex-col items-center px-6 py-12 gap-8">
      ...
      >
        ...
        <div className="text-center">
          ...
          <p className="text-sm text-gray-600 dark:text-white/60 mt-1.5 font-body">{t.subtitle}</p>
          <p className="text-xs text-gray-500 dark:text-white/40 font-body">{t.subtitleDetail}</p>
        </div>
        ...
        <div className="flex flex-wrap items-center justify-center gap-3">
          <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/80 dark:bg-white/[0.06] backdrop-blur-xl border border-gray-200/60 dark:border-white/10">
            ...
            <span className="text-xs text-gray-600 dark:text-white/60 font-body">{t.location}</span>
          </div>
          <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/80 dark:bg-white/[0.06] backdrop-blur-xl border border-gray-200/60 dark:border-white/10">
